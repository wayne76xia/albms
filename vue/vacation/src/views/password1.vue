...
export default {
  ...
  data() {
    return {
      ...
      loginRules: {
        username: [{ required: true, trigger: "blur", message: "Mobile phone number cannot be empty" }],
        password: [
        ...
        code: [
          { required: true, trigger: "blur", message: "The verification code cannot be empty" },
        ],
      },
      loading: false,
      redirect: undefined,
