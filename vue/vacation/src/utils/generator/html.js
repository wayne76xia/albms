...
// spanDon't for24useel-colThe parcel
...
function buildElUploadChild(conf) {
  ...
  if (conf.showTip) list.push(`<div slot="tip" class="el-upload__tip">Can only upload no more than ${conf.fileSize}${conf.sizeUnit} the${conf.accept}file</div>`)
  return list.join('\n')
}
